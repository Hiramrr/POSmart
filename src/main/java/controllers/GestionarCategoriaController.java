...
public class GestionarCategoriaController {
    ...
    GestionarCategoria_DAO mBD = new GestionarCategoria_DAO();
    ...
    private void cargarCategoria() {
        List<Categoria> categorias = mBD.obtenerCategorias();
    ...
    private void handleAgregarCategoria() {
        ...
        try {
            ...
            boolean success = mBD.agregarCategoria(categoriaID, categoriaNombre, ubicacionCategoria);
            if(success){
                cargarCategoria();
                limpiarCampos();
    ...
    private void handleModificarCategoria() {
        ...
        try {
            ...
            boolean success = mBD.modificarCategoria(categoriaID, categoriaNombre, categoriaDescripcion);
            if(success){
                cargarCategoria();
                limpiarCampos();
    ...
    private void handleEliminarCategoria() {
        ...
        boolean success = mBD.eliminarCategoria(categoriaSeleccionada.getId());
