...
public class GestionarUbicacionController {
    ...
    GestionarUbicacion_DAO mBD = new GestionarUbicacion_DAO();
    ...
    private void handleAgregarUbicacion() {
        ...
        try {
            ...
            boolean success = mBD.agregarUbicacion(ubicacionID,ubicacionNombre,ubicacionDescripcion);
            if(success){
                cargarUbicacion();
                limpiarCampos();
    ...
    private void handleModificarUbicacion() {
        ...
        try {
            ...
            String ubicacionNombre = nombre.getText();
            String ubicacionDescripcion = descripcion.getText();
            boolean success = mBD.modificarUbicacion(ubicacionID,ubicacionNombre,ubicacionDescripcion);
            if(success){
                cargarUbicacion();
                limpiarCampos();
    ...
    private void handleEliminarUbicacion() {
        ...
        boolean success = mBD.eliminarUbicacion(ubicacionSeleccionada.getId());
