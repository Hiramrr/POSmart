...
import BaseDatos.GestionarProveedores_DAO;
...
public class GestionarProveedoresController {
    ...
    GestionarProveedores_DAO mBD = new GestionarProveedores_DAO();
    ...
    private void cargarProveedores() {
        List<Proveedor> proveedores = mBD.obtenerProveedores();
    ...
    private void handleAgregarProveedor() {
        ...
        try {
            ...
            boolean success = mBD.agregarProveedor(proveedorId, proveedorNombre, proveedorTelefono, proveedorCorreo, proveedorDireccion);
    ...
    private void handleModificarProveedor() {
        ...
        try {
            ...
            boolean success = mBD.modificarProveedor(proveedorId, proveedorNombre, proveedorTelefono, proveedorCorreo, proveedorDireccion);
    ...
    private void handleEliminarProveedor() {
        ...
        boolean success = mBD.eliminarProveedor(proveedorSeleccionado.getId());
